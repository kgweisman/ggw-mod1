...
dd = read.csv("/Users/kweisman/Documents/Research (Stanford)/Projects/GGW-mod/ggw-mod1b/data/pilot_A_2017-05-11_data_anonymized.csv")[-1] # get rid of column of obs numbers
